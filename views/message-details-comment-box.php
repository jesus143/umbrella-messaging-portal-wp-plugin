...
<div class="ump-embedded-ticket-details">
    ...
    <div class="comment-box-container">
        ...
        <form method="post" action="<?php print get_site_url(); ?>/message-sent" enctype="multipart/form-data">
            <input type="hidden" name="umpReplySubject"
                   value="[#<?php print $ticketId; ?>] Re: Ticket Received - <?php print $ticketSubject; ?>"/>
            <textarea name="umpReplyMessage" style="height: 200px;">
            </textarea>
            <br>
            <input type="file" multiple name="file[]"
                   style="border: 1px solid #dadada;padding: 11px;background-color: #f6f6f6;"/>
            <br>
