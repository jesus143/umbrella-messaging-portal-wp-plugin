...
<div class="bs-example" data-example-id="list-group-custom-content">
    <div class="list-group">
        ...
        for ($i = 0; $i < count($tickets); $i++) :
            ...
            <a style='background-color:white;' class="list-group-item <?php print $notificationStatus; ?>"
               href="?section=message-details&ticketId=<?php print $tickets[$i]['id']; ?>&replyId=<?php print ump_get_reply_id($latestReply); ?>&tab=<?php print $tabAbbr; ?>"
               class="list-group-item <?php print $notificationStatus; ?> ">
            ...
            <span class="pull-right" style="font-size:12px"> 
                ...
                ?>
                <img style="<?php print $envelopStyle; ?>" class="pull-left" src="<?php print $envelopSrc; ?>"
                     alt="envelop"/>
                <!-- ticket subject -->
                <?php if ($notificationStatus == 'unread') {
                    print '<b>';
                } ?>
