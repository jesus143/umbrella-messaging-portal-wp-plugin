...
?>
<link rel="stylesheet"
      href="<?php print site_url(); ?>/wp-content/plugins/umbrella-messaging-portal/designer/reply-design.css">
<link href="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" rel="stylesheet">
<script type="text/javascript" src="http://code.jquery.com/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
<link rel="stylesheet"
      href="<?php print $site_url; ?>/wp-content/plugins/umbrella-messaging-portal/assets/css/custom_style.css"/>
<br><br>
            ...
            <ticket>
                <div style="margin-left: 20px;">
                    ...
                    <a href="?section=message-notification">
                        <button class="btn btn-default" class="ump-reply-ticket-submit"> Back</button>
                        <br><br>
                    </a>
                    ...
                    <div class="row row-container">
                        <div class="col-md-1 col-sm-2 hidden-xs">
                            <div class="thumbnail ump-thumbnail">
                                <img class="img-responsive ump-img-responseive"
                                     src="<?php print $profilePicSrcPartner; ?>" style="height:69px">
                            </div>
                        </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <header class="text-left">
                                        ...
                                        <div class="comment-user"><i
                                                class="fa fa-user"></i> <?php print $replyName; ?>
                                        </div>

                                        <time class="comment-date" datetime="16-12-2014 01:05"><i
                                                class="fa fa-clock-o"></i>
                                            <?php print $dateTimeCreatedAt; ?><br>
                                            <center><?php print '' . $timeCreated; ?></center>
                                            <br>
                                        </time>

                                    </header>

                                    <!-- Display content of the ticket -->
                ...
                <div style="width:-3%">
                    <?php for ($i = 0; $i < count($ticketReplies); $i++):
                        ...
                        <div class="row row-container " style="<?php print $row_style; ?>">
                            ...
                            <div class="col-md-10 col-sm-12 message-boxes-container <?php print $margin_left; ?>">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <header class="text-left">
                                            <div class="comment-user"><i
                                                    class="fa fa-user"></i> <?php print $replyName; ?> </div>
                                            <time class="comment-date" datetime="16-12-2014 01:05"><i
                                                    class="fa fa-clock-o"></i>
                                                <?php print ' ' . $dateTimeCreatedAt; ?><br>
                                                <center><?php print '' . $timeCreated; ?></center>
                            ...
                            <?php if ($isAgent == true): ?>
                                <div class="col-md-1 col-sm-2 hidden-xs "
                                     style="<?php print  $profile_pic_style; ?>">
                                    <div class="thumbnail ump-thumbnail">
                                        <img class="img-responsive ump-img-responseive"
                                             title="<?php print $user_id; ?>"
                                             src="<?php print $profilePicSrcAgent; ?>" style="height:69px;">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
