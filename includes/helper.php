...
function ump_getAgentWpUserIdByFdUserId($fd_agent_user_id)
{
	global $wpdb;
	$fdAgentInfo = $wpdb->get_results( "SELECT * FROM wp_usermeta WHERE  meta_key = 'wp_fd_agent_id' and meta_value = $fd_agent_user_id" );
//	    print "<pre>";
//		print "testing";
//	    print_r($fdAgentInfo);
//	    print "</pre>";
	...
	foreach($fdAgentInfo as $agent) {
		if($agent->meta_value == $fd_agent_user_id) {
...
function ump_getAgentProfilePicByWpUserId($wp_user_id)
{
	global $wpdb;
	$fdAgentInfo = $wpdb->get_results( "SELECT * FROM  " . $wpdb->prefix . "usermeta WHERE meta_key = 'wp_fd_agent_profile_pic_url' and  user_id = $wp_user_id" );
	//    print "<pre>";
	//    print_r($fdAgentInfo);
	//    print "</pre>";
	foreach($fdAgentInfo as $agent) {
		return $agent->meta_value;
	}
}
function ump_getAgentFullNameByWpUserId($wp_user_id)
{
	global $wpdb;
	$fdAgentInfo = $wpdb->get_results( "SELECT * FROM " . $wpdb->prefix . "usermeta WHERE meta_key = 'wp_fd_agent_full_name' and  user_id = $wp_user_id" );
	//    print "<pre>";
	//    print_r($fdAgentInfo);
	//    print "</pre>";
	foreach($fdAgentInfo as $agent) {
...
function ump_getAgentFullName($fd_agent_user_id)
{
	...
	if($wp_user_id) {
		return ump_getAgentFullNameByWpUserId($wp_user_id);
	} else {
